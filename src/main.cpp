...
public:
    ...
    LRUCache(size_t maxRamUsageBytes, RetrieveFunc retrieveFunc, size_t thrashingWindow = 100, size_t cleanUpThreshold = 10)
...
int main() {
    ...
    LRUCache<int, std::vector<int>> cache(max_size, retrieveFunc); // 8 GB max RAM usage
